...
namespace Maikon_ns {//MasterEm_TD2_a {
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
            ...
            this->btnSerialOpen = (gcnew System::Windows::Forms::Button());
            ...
            // btnSerialOpen
            // 
            this->btnSerialOpen->Location = System::Drawing::Point(451, 221);
            this->btnSerialOpen->Name = L"btnSerialOpen";
            this->btnSerialOpen->Size = System::Drawing::Size(75, 75);
            this->btnSerialOpen->TabIndex = 8;
            this->btnSerialOpen->Text = L"SerialOpen";
            this->btnSerialOpen->UseVisualStyleBackColor = true;
            this->btnSerialOpen->Click += gcnew System::EventHandler(this, &Form_Maikon::btnSerialOpen_Click);
            // 
            // btnProd
            // 
            this->btnProd->Location = System::Drawing::Point(451, 188);
            this->btnProd->Name = L"btnProd";
            this->btnProd->Size = System::Drawing::Size(75, 27);
            this->btnProd->TabIndex = 9;
            this->btnProd->Text = L"Prod Serial";
            this->btnProd->UseVisualStyleBackColor = true;
            this->btnProd->Click += gcnew System::EventHandler(this, &Form_Maikon::btnProd_Click);
            // 
            // Form_Maikon
            // 
...
#pragma endregion
    ...
    private:
     ...
     private:
        ...
        System::Void btnSerialOpen_Click(System::Object^  sender, System::EventArgs^  e)
        {
            if( this->maikon->serial_IsOpen() != true )
            {
                this->maikon->serial_Open();
            }         

            this->maikon->serialPort_Prod();
        }


        System::Void btnProd_Click(System::Object^  sender, System::EventArgs^  e)
        {
            if( this->maikon->serial_IsOpen() == true )
            {
                this->maikon->serialPort_Prod();
