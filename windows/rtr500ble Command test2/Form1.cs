...
namespace rtr500ble_Command_test
{
    public partial class Form1 : Form
    {
        ...
        */
        ...
        //=====================================================================
        public TDnRFcontroller_LIB.TDnRFcontroller bleCtrl;
        bool Flag_bleInitStarted;
        volatile bool Flag_bleInitDone;

        public void local_bleInit()
        {
            protocol_T2 = new Protocol_T2();
            protocol_T2.userEv_LogMessage += protocol_T2_userEv_LogMessage;
            bleCtrl = new TDnRFcontroller_LIB.TDnRFcontroller();
            ...
            button_Enable(btnBLE_ScanStart, false);
            button_Enable(btnBLE_ScanStop, false);
            ...
            bleCtrl.appEv_Initialized += On_bleCtrl_Initialized;
            
            bleCtrl.appEv_ScanningStarted += On_bleCtrl_ScanningStarted;
            bleCtrl.appEv_DeviceInfoUpdate += bleCtrl_appEv_DeviceInfoUpdate;
            bleCtrl.appEv_ScanningCancelled += On_bleCtrl_ScanningCancelled;
            
            bleCtrl.appEv_ConnectionStarted += On_bleCtrl_ConnectionStarted;
            bleCtrl.appEv_ConnectionCancelled += On_bleCtrl_ConnectionCancelled;
            bleCtrl.appEv_Connected += ON_bleCtrl_Connected;
            bleCtrl.appEv_ServiceDiscoveryCompleted += On_bleCtrl_ServiceDiscoveryCompleted;
            bleCtrl.appEv_Disconnected += On_bleCtrl_Disconnected;

            bleCtrl.userEv_udPacket += OnEvent_udPacket;


            bleCtrl.SendDataStarted += On_bleCtrl_SendDataStarted;
            bleCtrl.SendDataCompleted += On_bleCtrl_SendDataCompleted;
        ...
        //=====================================================================
        //=====================================================================
        void On_bleCtrl_Initialized(object sender, EventArgs e)
        {
            Flag_bleInitDone = true;
            //throw new NotImplementedException();
            
            richTextBox1_AppendText("On_bleCtrl_Initialized" + "\r\n");

            // Buttons
            button_Enable(btnBLE_Init, false);
            button_Enable(btnBLE_Close, true);
            button_Enable(btnBLE_ScanStart, true);
            button_Enable(btnBLE_ScanStop, false);
        ...
        //---------------------------------------------------------------------
        private void btnBLE_Init_Click(object sender, EventArgs e)
        {
            ...
            bleCtrl.Controller_Initialize();

            while (Flag_bleInitDone == false)
            {
                Application.DoEvents();
                //TODO Time out
            }
        ...
        private void btnBLE_Close_Click(object sender, EventArgs e)
        {
            button_Enable(btnBLE_Close, false);
        ...
        //---------------------------------------------------------------------
        void On_bleCtrl_ScanningStarted(object sender, EventArgs e) {
            richTextBox1_AppendText("On_bleCtrl_ScanningStarted" + "\r\n");

            // Buttons
            button_Enable(btnBLE_Init, false);            
            button_Enable(btnBLE_Close, false);
            button_Enable(btnBLE_ScanStart, false);
            button_Enable(btnBLE_ScanStop, true);
            button_Enable(btnBLE_AutoConnect, false);
            button_Enable(btnBLE_Connect, false);
            button_Enable(btnBLE_Disconnect, false);
            button_Enable(btnBLE_TestSend, false);
        ...
        //---------------------------------------------------------------------
        void On_bleCtrl_ScanningCancelled(object sender, EventArgs e) {
            richTextBox1_AppendText("On_bleCtrl_ScanningCancelled" + "\r\n");
        ...
        private void btnBLE_ScanStart_Click(object sender, EventArgs e)
        {
            bool bStatus;
        ...
        private void btnBLE_ScanStop_Click(object sender, EventArgs e)
        {
        ...
        private void btnBLE_AutoConnect_Click(object sender, EventArgs e)
        {
            bool bStatus;
            bStatus = bleCtrl.InitiateAutoConnect("FA92D0BB1C98");
        }

        private void btnBLE_Connect_Click(object sender, EventArgs e)
        {
            bool bStatus;
            bStatus = bleCtrl.Connect_to_device_address("FA92D0BB1C98");
        }
        ...
        void On_bleCtrl_ConnectionStarted(object sender, EventArgs e) {
        ...
        void On_bleCtrl_ConnectionCancelled(object sender, EventArgs e) {
            richTextBox1.AppendText("On_bleCtrl_ConnectionCancelled" + "\r\n");
            // Buttons
            button_Enable(btnBLE_Init, false);
            button_Enable(btnBLE_Close, true);
            button_Enable(btnBLE_ScanStart, true);
        ...
        void On_bleCtrl_Disconnected(object sender, EventArgs e) {
        ...
        void ON_bleCtrl_Connected(object sender, EventArgs e)
        {
        ...
        void On_bleCtrl_ServiceDiscoveryCompleted(object sender, EventArgs e) {
        ...
        //=====================================================================
        //=====================================================================
        void On_bleCtrl_SendDataStarted(object sender, EventArgs e) { }
        void On_bleCtrl_SendDataCompleted(object sender, EventArgs e) { }
